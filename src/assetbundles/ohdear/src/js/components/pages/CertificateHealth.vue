        ...
        <div v-if="certificateHealth">
            <table class="data collapsible">
                ...
                <tr>
                    ...
                    <td>
                        <svg
                            v-if="certificateHealth.certificateChecks.find(check => {return check.type === 'invalidChain'}).passed"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="oh-h-6 oh-w-6">
                            <circle class="oh-text-green-200 oh-fill-current" cx="12" cy="12" r="10"/>
                            <path class="oh-text-green-600 oh-fill-current"
                                  d="M10 14.59l6.3-6.3a1 1 0 0 1 1.4 1.42l-7 7a1 1 0 0 1-1.4 0l-3-3a1 1 0 0 1 1.4-1.42l2.3 2.3z"/>
                        </svg>
